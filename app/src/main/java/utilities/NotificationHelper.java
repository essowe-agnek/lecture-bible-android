...
class NotificationHelper extends ContextWrapper {
    ...
    private static final String CHANNEL_HIGH_ID = "com.agnekdev.planlecturebible.HIGH_CHANNEL";
    private static final String CHANNEL_HIGH_NAME = "High Channel";

    private static final String CHANNEL_DEFAULT_ID = "com.agnekdev.planlecturebible.DEFAULT_CHANNEL";
